...
export const countryOptions: CountryOption[] = [
  ...
  { code: "+966", country: "SA", flag: "sa", label: "Saudi Arabia", placeholder: "50 123 4567" },
];
...
export function CountryFlag({ country }: { country: CountryOption }) {
  ...
  return <svg className="country-flag" viewBox="0 0 32 20" role="img" aria-label={`${country.label} flag`}><rect width="32" height="20" rx="2" fill="#17804e" /><path d="M5 10h22" stroke="#fff" strokeWidth="1" /><path d="M16 5.2c-2.3 1-2.3 8.6 0 9.6-3.5-.2-5.2-2.3-5.2-4.8S12.5 5.4 16 5.2z" fill="#fff" /></svg>;
}
