...
export default function RoleDetails({ roleId, userEmail, canReviewRole, canApproveRole }: Props) {
  ...
  return <main className="container page role-details-page">
    ...
    <div className="role-layout"><div className="role-main-column">
      ...
      <Card title="HR Interview and Screening"><DefinitionList><Field label="HR / Interviewer Email" value={role.hodEmail} wide/><Field label="Final Interview Availability" value="Managed through the connected HR Google Calendar" wide/><Field label="Custom HR Screening Question 1" value={role.customScreeningQuestion1} wide/><Field label="Custom HR Screening Question 2" value={role.customScreeningQuestion2} wide/><Field label="AI-Generated Screening Questions" value={role.aiGeneratedScreeningQuestions} wide/></DefinitionList></Card>
