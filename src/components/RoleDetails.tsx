...
type RoleRequestDetails = {
  ...
  requestType: string; roleCountry: string; department: string; jobTitle: string; numberOfVacancies: number; reasonForRequest: string;
