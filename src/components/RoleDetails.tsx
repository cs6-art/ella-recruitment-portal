...
export default function RoleDetails({ roleId, userEmail, canReviewRole, canApproveRole }: Props) {
  ...
  return <main className="container page role-details-page">
    ...
    <div className="role-layout"><div className="role-main-column">
      ...
      <Card title="HR Interview and Screening"><DefinitionList><Field label="Shared HR Calendar Account" value={role.hodEmail || "Configured in Settings"} wide/><Field label="Final Interview Availability" value="Managed through the shared HR Google Calendar configured in Settings" wide/><Field label="Custom HR Screening Question 1" value={role.customScreeningQuestion1} wide/><Field label="Custom HR Screening Question 2" value={role.customScreeningQuestion2} wide/><Field label="AI-Generated Screening Questions" value={role.aiGeneratedScreeningQuestions} wide/></DefinitionList></Card>
    ...
    {/* Detail pages are read-only; role and setup changes belong on the dedicated edit route. */}
