...
console.log("=== STEP 2: HR sends for management approval ===");
...
console.log(step2.status, JSON.stringify(step2.json));
...
console.log(step3.status, JSON.stringify(step3.json));
