...
["Status 2 (Voice Interview)", "Voice_Interview_Booking_Status", "Voice_Interview_Scheduled_Date", "Voice_Interview_Scheduled_Time", "Voice_Interview_Timezone"].forEach((f) => console.log(`${f}: ${row[headers.indexOf(f)] || "(empty)"}`));
